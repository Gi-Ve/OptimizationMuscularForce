function [outputArg1] = OptimizationSoftSaturation(momH,momHAbb,momK,momA)
...
p = inputdlg({'Set order for Soft Saturation Criterion'});
p=str2num(p{1});
...
f(1)=(1-(x(1)/42.96).^p).^(1/p);
f(2)=(1-(x(2)/23.33).^p).^(1/p);
f(3)=(1-(x(3)/20.20).^p).^(1/p);
f(4)=(1-(x(4)/25.70).^p).^(1/p);
f(5)=(1-(x(5)/46.33).^p).^(1/p);
f(6)=(1-(x(6)/11.52).^p).^(1/p);
f(7)=(1-(x(7)/18.35).^p).^(1/p);
f(8)=(1-(x(8)/22.73).^p).^(1/p);
f(9)=(1-(x(9)/27.34).^p).^(1/p);
f(10)=(1-(x(10)/25).^p).^(1/p);
f(11)=(1-(x(11)/25).^p).^(1/p);
f(12)=(1-(x(12)/6.76).^p).^(1/p);
f(13)=(1-(x(13)/50.60).^p).^(1/p);
f(14)=(1-(x(14)/66.87).^p).^(1/p);
f(15)=(1-(x(15)/82).^p).^(1/p);
f(16)=(1-(x(16)/64.41).^p).^(1/p);
f(17)=(1-(x(17)/8.18).^p).^(1/p);
f(18)=(1-(x(18)/186.69).^p).^(1/p);
f(19)=(1-(x(19)/16.88).^p).^(1/p);
f(20)=(1-(x(20)/24.55).^p).^(1/p);
f = -sum(f.^p);
end