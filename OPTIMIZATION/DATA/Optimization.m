function [outputArg1] = Optimization(momH,momHAbb,momK,momA,weight,height)

%OPTIMIZATION LOWER LIMB

NF=height/172;
%%%% data loading: moment arms and joint moments %%%%

if 0 == 0
%================ hip flexion/extension + normalization ======================
valorimhipflex = momH;
newX = (0:0.02:1)';
...
valoribraccioRFhflex.Var2=valoribraccioRFhflex.Var2*NF;
valoribraccioILhflex.Var2=valoribraccioILhflex.Var2*NF;
valoribraccioGMAXhflex.Var2=valoribraccioGMAXhflex.Var2*NF;
valoribraccioPShflex.Var2=valoribraccioPShflex.Var2*NF;
valoribraccioSMhflex.Var2=valoribraccioSMhflex.Var2*NF;
valoribraccioADDBhflex.Var2=valoribraccioADDBhflex.Var2*NF;
valoribraccioADDGhflex.Var2=valoribraccioADDGhflex.Var2*NF;
valoribraccioADDLhflex.Var2=valoribraccioADDLhflex.Var2*NF;
valoribraccioBFCLhflex.Var2=valoribraccioBFCLhflex.Var2*NF;
valoribraccioGPIChflex.Var2=valoribraccioGPIChflex.Var2*NF;
%%============== ankle flexion/extension =======================
valorimankleflex = momA;
newX = (0:0.02:1)';
...
valoribraccioGASaflex.Var2=valoribraccioGASaflex.Var2*NF;
valoribraccioSOaflex.Var2=valoribraccioSOaflex.Var2*NF;
valoribraccioTAaflex.Var2=valoribraccioTAaflex.Var2*NF;
valoribraccioPEaflex.Var2=valoribraccioPEaflex.Var2*NF;
...
valoribraccioRFkflex.Var2=valoribraccioRFkflex.Var2*NF;
valoribraccioGASkflex.Var2=valoribraccioGASkflex.Var2*NF;
valoribraccioBFCBkflex.Var2=valoribraccioBFCBkflex.Var2*NF;
valoribraccioBFCLkflex.Var2=valoribraccioBFCLkflex.Var2*NF;
valoribraccioSMkflex.Var2=valoribraccioSMkflex.Var2*NF;
valoribraccioVMkflex.Var2=valoribraccioVMkflex.Var2*NF;
valoribraccioVIkflex.Var2=valoribraccioVIkflex.Var2*NF;
valoribraccioVLkflex.Var2=valoribraccioVLkflex.Var2*NF;
%================= hip abduction/adduction =========================
valorimhipadd = momHAbb;
newX = (0:0.02:1)';
...
valoribraccioRFhadd.Var2=valoribraccioRFhadd.Var2*NF;
valoribraccioGMAXhadd.Var2=valoribraccioGMAXhadd.Var2*NF;
valoribraccioPShadd.Var2=valoribraccioPShadd.Var2*NF;
valoribraccioSMhadd.Var2=valoribraccioSMhadd.Var2*NF;
valoribraccioADDBhadd.Var2=valoribraccioADDBhadd.Var2*NF;
valoribraccioADDGhadd.Var2=valoribraccioADDGhadd.Var2*NF;
valoribraccioADDLhadd.Var2=valoribraccioADDLhadd.Var2*NF;
valoribraccioBFCLhadd.Var2=valoribraccioBFCLhadd.Var2*NF;
valoribraccioGMEDahadd.Var2=valoribraccioGMEDahadd.Var2*NF;
valoribraccioGMEDphadd.Var2=valoribraccioGMEDphadd.Var2*NF;
valoribraccioGPIChadd.Var2=valoribraccioGPIChadd.Var2*NF;
...
for k = 1:51
    ...
    % function calling
    [x,fval] = fminimax(@myfun,x0,A,b,Aeq,beq,lb,ub,nonlcon,options);
    sol = vertcat(sol,x);
end
